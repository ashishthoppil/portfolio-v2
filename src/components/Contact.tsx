...
export const Contact = () => {
  return (
    ...
    >
      ...
      <div className="absolute sm:block -bottom-[300%] left-[5%] w-[17rem] h-[15rem] sm:w-[33rem] sm:h-[30rem] bg-red-400 rounded-full mix-blend-multiply filter blur-xl opacity-40 animate-blob animation-delay-4000"></div>
